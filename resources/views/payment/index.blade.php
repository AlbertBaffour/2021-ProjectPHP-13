...
@section('main')
    ...
    <div class="float-lg-right">  Hint:   <span> <i class="text-info fas fa-square"></i> Algemene onkosten |
        ...
        <div class="d-flex flex-wrap justify-content-between"><h1 class="">Betaling afhandelen</h1>
        </div>

{{--    status filter--}}
    <form method="get" action="/payment_review" id="searchForm">
        @csrf
...
{{--            <td> € {{ number_format($expense_allowance->id,2) }}</td>--}}
            ...
            <td ><a href="payment_review/{{$expense_allowance->id}}/edit" data-toggle="tooltip" data-placement="top" title="betaling verwerken" class=""><i class="fas fa-check-double text-dark"></i></a></td>
        </tr>
        @endforeach
...
{{--            <td> € {{ number_format($expense_allowance->id,2) }}</td>--}}
            ...
            <td ><a href="payment_review/{{$laptop_allowance->id}}/edit2" data-toggle="tooltip" data-placement="top" title="betaling verwerken" class=""><i class="fas fa-check-double text-dark"></i></a></td>
        </tr>
        @endforeach
        </tbody>
    </table>
