...
@section('main')
    ...
    @csrf
    <div class="d-flex flex-wrap justify-content-around"><h1 class="">Laptopvergoeding Aanvraag</h1>
          </div>
    @include('shared.alert')
            <Form class="pb-5 shadow  p-3 col-10 m-auto"  id="LForm" action="/laptop_allowances" method="post" enctype="multipart/form-data">
                @csrf
@include('laptop_allowance.form')

                    <div class="m-auto">
                    <button id="addLaptopAllowance" type="submit" class="col-4 btn btn-primary">Aanvraag indienen</button>
